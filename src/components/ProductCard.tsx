          ...
          <div className="absolute top-3 right-3 flex flex-col gap-2">
            ...
            {enableQuickView && (
              <button
                ...
                className="inline-flex h-8 w-8 items-center justify-center rounded-full border bg-background/90 backdrop-blur-sm shadow-sm opacity-0 group-hover:opacity-100 transition-opacity hover:scale-105"
